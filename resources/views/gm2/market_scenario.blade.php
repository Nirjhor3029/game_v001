    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg" style="padding:40px;box-sizing:border-box">
                <div class="row">
                    <div class="col-md-6">
                        <div><h3 class="text-center">Table 2</h3></div>
                        <table class="table table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                <th scope="col" colspan="4" class="text-center">Cost per outlet for offering a new line
                                ...
                                $.ajax({
                                    ...
                                    success:function (data) {
                                      //  console.log(data);return;
                                        $('#subcategory').empty();
                                        $('#subcategory').append('<option selected>Select type</option>');
                                        $.each(data.subcategories[0].sub_costs,function(index,subcategory){
                                            $('#subcategory').append('<option data-cost="'+subcategory.value+'" value="'+subcategory.id+'">'+subcategory.name+'</option>');
                                        })
