                ...
                <div class="col-md-6">
                    <div class="card gm2_card_rest">
                        ...
                        <div class="card-header gm2_card_header"
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    {{txtFormate($resGroup->restaurant->name)}}
                                    ({{txtFormate($resGroup->restaurantGroup->name)}})
                            ...
                            <div class="row inputField_row">
                                ...
                                <div class="col-md-3">
                                    <input type="number" name="" min="1"
                                           class="form-control-sm form-control number_of_outlets" value="1">
                                </div>
                        ...
                        <div class="card-header gm2_card_header"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 go-right">
                                    <span class="gm2-total-text">Total: </span>
                                    <span
                                        class="gm2-total-value">{{($market->total_cost - $market->marketCost[0]->competitors_move)}}</span>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row inputField_row">
                                <div class="col-md-3">
                                    ...
                                    <select name="" id="typeArea" name="cat_id"
                                            class="form-control-sm form-control type"
                                            data-type="1">
                                        <option selected value="0">Select Areas</option>
                                        @foreach($typeArea as $item)
                                            <option
                                                value="{{$item->id}}" {{($market->marketCost[0]->area_type == $item->id)? "selected":""}} >{{$item->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-3 subclass">
                                ...
                                <div class="col-md-3">
                                    <input type="number" name="" class="form-control-sm form-control number_of_outlets"
                                           value="{{$market->marketCost[0]->number_of_outlets}}" min="1">
                                </div>
                                <div class="col-md-2 cost_class">
                                    <input type="text" class="form-control-sm form-control cost_value" readonly
                                           value="{{$market->marketCost[0]->area}}" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3">
                            ...
                            <div class="row inputField_row">
                                <div class="col-md-3">
                                    <select name="" id="typeQuantity" class="form-control-sm form-control type"
                                        ...
                                        @foreach($typeQuantity as $item)
                                            <option
                                                value="{{$item->id}}" {{($market->marketCost[0]->quality_type == $item->id)? "selected":""}}>{{$item->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-3 subclass">
                                ...
                                <div class="col-md-2 cost_class">
                                    <input type="text" id="typeQuantity_cost_value"
                                           class="form-control-sm form-control cost_value"
                                           value="{{$market->marketCost[0]->quality}}" readonly required>
                                </div>
                            </div>
                                    ...
                                    <div class="row marketing-row">
                                        ...
                                        <div class="col-sm-6">
                                            @foreach($market->marketCost[0]->gm2MarketPromotion as $key=> $marketPromotion)
                                                <div class="form-group">
                                                    <label
                                                        for="">{{ txtFormate($promotion_options[$key]['name'])}}</label>
                                                    <input type="number"
                                                           class="form-control-sm form-control discount_within_store ajx_input_market_promotion"
                                ...
                                <div class="col-sm-6">
                                    @foreach($restaurantGroups as $group)
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" id="" name="attack_group"
                                                   value="{{$group->id}}"
                                                   {{($group->id == $resturentUser->rest_group_id  )? "checked":""}} required>
                                            <label class="form-check-label" for="">{{$group->name}}</label>
                                        </div>
                                    @endforeach
                                </div>
