                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="progress-bar-container">
                                    <progress max="{{$min_max[0]['max']}}" value="{{$min_max[0]['actual']}}" class="html5 progress-custom">
                                    </progress>
                                    <span style="margin-left: {{$min_max[0]['actual']/2}}%" class="progress-inner-label">{{$min_max[0]['actual']}}</span>
                                </div>
                                <p>{{$min_max[0]['max']}}</p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="progress-bar-container">
                                    <progress max="{{$min_max[1]['max']}}" value="{{$min_max[1]['actual']}}" class="html5 progress-custom">
                                    </progress>
                                    <span style="margin-left: {{$min_max[1]['actual']/2}}%" class="progress-inner-label">{{$min_max[1]['actual']}}</span>
                                </div>
                                <p>{{$min_max[1]['max']}}</p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="progress-bar-container">
                                    <progress max="{{$min_max[2]['max']}}" value="{{$min_max[2]['actual']}}" class="html5 progress-custom">
                                    </progress>
                                    <span style="margin-left: {{$min_max[2]['actual']/2}}%" class="progress-inner-label">{{$min_max[2]['actual']}}</span>
                                </div>
                                <p>{{$min_max[2]['max']}}</p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="progress-bar-container">
                                    <progress max="{{$min_max[3]['max']}}" value="{{$min_max[3]['actual']}}" class="html5 progress-custom">
                                    </progress>
                                    <span style="margin-left: {{$min_max[3]['actual']/2}}%" class="progress-inner-label">{{$min_max[3]['actual']}}</span>
                                </div>
                                <p>{{$min_max[3]['max']}}</p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="progress-bar-container">
                                    <progress max="{{$min_max[4]['max']}}" value="{{$min_max[4]['actual']}}" class="html5 progress-custom">
                                    </progress>
                                    <span style="margin-left: {{$min_max[4]['actual']/2}}%" class="progress-inner-label">{{$min_max[4]['actual']}}</span>
                                </div>
                                <p>{{$min_max[4]['max']}}</p>
                            </div>
                        </div>
