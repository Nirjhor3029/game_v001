                    ...
                    <div class="col-md-5">
                        ...
                        <div class="row" style="margin-bottom:30px;">
                            ...
                            <p class="aside_details">
                                You need to make a cash flow statement, and profit and loss statement from the table. To make it perfect please choose from the list.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-7">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="left-side-container">
                                    ...
                                    <div style="background-color: #002060;margin-bottom: 5px;padding: 5px 10px;margin-bottom:5px;">
                                            ...
                                            <?php $mimnus_data = array();?>
                                             @if(!is_null($revenueData))
                                                @foreach($revenueData as $ree)
                                                    <li data-tag="{{$ree->title}}" data-pay="{{$ree->value}}"> {{$ree->title}} <span style="float: right">{{$ree->value}} BDT</span></li>
                                    ...
                                    <p style="background-color:#F4F5F7;margin-top:5px;padding:5px;">Total Net Revenue <span id="total_revenues" style="float:right;font-weight:bold">{{$total_revenue}} BDT</span></p>



                                    <div style="background-color: #002060;margin-bottom: 5px;padding: 5px 10px;margin-bottom:5px;margin-top:30px;">
                                        <p style="padding: 0px; color: white;margin: 0px;">Expenses</p>
                                    </div>
                                    <div  class="" style=";width:100%;border:1px solid rgb(224, 224, 224);">
                                        <ul id="expenses" class="revinew_left_list" style="height:230px;overflow-y:auto">
                                    ...
                                    <p style="background-color:#F4F5F7;margin-top:5px;padding:5px;">Total Expenses <span id="total_expenses" style="float:right;font-weight:bold">{{$total_expenses}} BDT</span></p>

                                    <p style="background-color:#0070C0;margin-top:5px;padding:5px;font-weight:bold;color:white">Net Income <span id="netincome_result" style="float:right;font-weight:bold">{{$total_income}} BDT</span></p>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <ul id="sortable" class="revinew_right_list" style="min-height: 600px;">
                                        ...
                                        @foreach($options as $option)
                                            @if(!in_array(trim($option->title),$mimnus_data))
                                                <?php $i++;?>
                                                <li data-tag="{{$option->title}}" data-pay="{{$option->value}}"> {{$option->title}} <span style="float: right">{{$option->value}} BDT</span></li>
                                            @endif
                                        @endforeach
                                ...
                                <a class="btn btn-primary float-right" href="{{url('cash-flow-statements')}}" style="margin-top:50px;">Next</a>
