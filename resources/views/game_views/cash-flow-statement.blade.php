            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg" style="padding:40px;box-sizing:border-box">
                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <p class="aside_details">You need to make a cash flow statement, and profit and loss statement from the table. To make it perfect please choose from the list</p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="left-side-container">
                                    ...
                                    <div  class="" style=";width:100%;border:1px solid rgb(224, 224, 224);">
                                        <ul id="expenses" class="revinew_left_list" style="height:190px;overflow-y:auto">
                                    ...
                                    <p style="background-color:#0070C0;margin-top:5px;padding:5px;font-weight:bold;color:white">Net Cash flow <span id="netincome_result" style="float:right;font-weight:bold">{{$total_income}} BDT</span></p>
